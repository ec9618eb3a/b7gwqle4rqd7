...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.8be08.js';
        if (jsList) {
...
// main.e7e86.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
