...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.ef78c.js';
        if (jsList) {
...
// main.f32ed.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
