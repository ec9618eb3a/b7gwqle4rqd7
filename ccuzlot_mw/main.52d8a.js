...
window.boot = function () {
    ...
    function setLoadingDisplay () {
        ...
        var splash = document.getElementById('cc-splash');
		var progressBar = splash.querySelector('.cc-progress-bar span');
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.f28e3.js';
        if (jsList) {
...
// main.52d8a.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
